  ...
  return (
    <div className="h-screen flex flex-col md:flex-row items-center justify-center gap-6 px-6 py-16 bg-gray-100">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 text-center max-w-xs md:max-w-sm">
        ...
        <button onClick={()=>router.push('/hruserside/dashboard')} className="cursor-pointer mt-4 px-6 py-2 border border-blue-600 text-blue-600 rounded-lg font-medium hover:bg-blue-100">
          Post a job
        </button>
      </div>
    </div>
